/*-----------------------------------------------------------------------------
 * Umicom Platform
 * File: include/umicom/platform/workspace/build_plan.h
 *
 * PURPOSE:
 *   Create a project build plan without invoking product build systems.
 *
...
#ifndef UMICOM_PLATFORM_BUILD_PLAN_H
#define UMICOM_PLATFORM_BUILD_PLAN_H
