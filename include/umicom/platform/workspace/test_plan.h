/*-----------------------------------------------------------------------------
 * Umicom Platform
 * File: include/umicom/platform/workspace/test_plan.h
 *
 * PURPOSE:
 *   Create a project test plan without running downstream tests.
 *
...
#ifndef UMICOM_PLATFORM_TEST_PLAN_H
#define UMICOM_PLATFORM_TEST_PLAN_H
