...
static const char *COMMANDS[]={"status","suite","integration-graph","graph","sync","framework-audit","lock-plan","lock","build-plan","test-plan","codeguard-plan","os-ui","remote-plan","migration-plan"};
