/*-----------------------------------------------------------------------------
 * Umicom Platform
 * File: tests/test_submodule_parse_different.c
 *
 * PURPOSE:
...
int main(void){UmiSubmoduleRecord r;UMI_TEST_ASSERT(umi_submodule_status_parse_line("+26eef4fa8a8da05f8d4e653e04e87a61ca6effec framework",&r));UMI_TEST_ASSERT(r.state==UMI_SUBMODULE_DIFFERENT_COMMIT);return 0;}
