/*-----------------------------------------------------------------------------
 * Umicom Platform
 * File: tests/test_submodule_parse_initialized.c
 *
 * PURPOSE:
...
int main(void){UmiSubmoduleRecord r;UMI_TEST_ASSERT(umi_submodule_status_parse_line(" 26eef4fa8a8da05f8d4e653e04e87a61ca6effec framework (heads/main)",&r));UMI_TEST_ASSERT(r.state==UMI_SUBMODULE_INITIALIZED);UMI_TEST_ASSERT(strcmp(r.path,"framework")==0);return 0;}
