/*-----------------------------------------------------------------------------
 * Umicom Platform
 * File: tests/test_workspace_plan.c
 *
 * PURPOSE:
...
int main(void){UmiWorkspacePlan p;umi_workspace_plan_init(&p,"x");UMI_TEST_ASSERT(umi_workspace_plan_add(&p,"a"));UMI_TEST_ASSERT(p.step_count==1u);return 0;}
